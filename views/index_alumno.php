...
<body>
  <?php require_once("../navbar.php");?>
    ...
    <div class="table-responsive">
      <table id="mantenimiento_alumno" class="table-striped table-bordered table-hover">
        <thead>
          <tr>
            <th>
              ID Alumno
 ...
 include_once("../controllers/alumno_controller.php ");
          ...
          <tr>
            ...
            <td><a class="btn btn-warning "
                href="editar_alumno.php?id_alumno=<?php echo $alumno->getId_alumno(); ?>">Editar</a>
            </td>
            <td><a class="btn btn-danger "
                href="eliminar_alumno.php?id_alumno=<?php echo $alumno->getId_alumno(); ?>">Eliminar</a>
            </td>
